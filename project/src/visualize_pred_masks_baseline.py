...
experiment_name = 'DPTSegmentationModel'
...
#
# best_model = ISPModel.load_from_checkpoint(checkpoint_path=CHECKPOINT, architecture='FPN',
#                                            encoder='resnet34')
...
def visualize_step(data, output_path, colours, images_gt_dict, iou_dict, f1_dict, f1_score_list, iou_list):
    ...
    fig.tight_layout()
    fig.savefig(output_path.joinpath(experiment_name + '_' + img_path.name))
    fig.clear()
    plt.close(fig)
